      ...
      <div className=" bg-gradient-to-r from-red-500 to-orange-200  text-center px-10 py-5  md:py-16 md:px-8  ">
        ...
        <div className="grid md:grid-cols-2 grid-cols-1   md:my-8 md:mx-40  bg-gray-300 rounded-2xl">
          ...
          <div className="px-10 py-10 md:px-20 md:py-8">
            ...
            <h1 className="text-4xl md:mb-5 font-bold text-gray-800 hover:text-red-500">Ronald Lim Sheng Wei</h1>
            <div class="py-4">
              <div className="border-t border-2 border-gray-500"></div>
            </div>
            <p className="text-center text-xl font-semibold text-gray-700">Bachelor of Computer Science (Software Engineering) with Honours</p>
          ...
          <div className="px-10 py-10 md:py-8 md:px-20 ">
            ...
            <div className="grid xl:grid-cols-4  grid-cols-1 gap-4">
              ...
              <button className="font-semibold rounded-full bg-slate-500 py-1 px-4 hover:bg-gradient-to-r from bg-sky-600 to-orange-400">
              <AnchorLink href='#project_details'>Project</AnchorLink>
              </button>
